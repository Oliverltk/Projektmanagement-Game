...
rules_content.innerHTML = `
  ...
  <p>Die Spieleranzahl kann über ein Dropdown Menü eingestellt werden.</p>
  ...
  <p>Zu Beginn wird eine Figur jeder Farbe auf das zugehörige Startfeld gestellt. Der jüngste Spieler beginnt, danach wird im Uhrzeigersinn gewürfelt und gezogen. Die Person die an der Reihe ist würfelt und zieht mit einer Figur die Augenzahl 6. Falls ein Spieler mehrere Figuren auf dem Spielfeld hat, kann die jeweilige Figur durch Anklicken gewählt werden.</p>
  ...
  <p>Eine Spielfigur kann aus dem Wartefeld auf das Startfeld gestellt werden, wenn die Augenzahl wieder gewürfelt wird.</p>
  <p>Sollte die Augenzahl gewürfelt werden, darf der Spieler erneut würfeln.</p>
`;
